...
public final class NoClipControllerComponent extends Component {
    ...
    private TransformComponent transformFlashlight;
    ...
    public NoClipControllerComponent(Entity entity, Button buttonMoveForward, Button buttonMoveBackward, Button buttonMoveLeft, Button buttonMoveRight, Button buttonRotateUp, Button buttonRotateDown, Button buttonRotateLeft, Button buttonRotateRight, Entity flashlight) {
        super(entity);
    ...
    public void onStart() {
        ...
        this.transformFlashlight = this.flashlight.getComponent(TransformComponent.class);
    }
    ...
    public void onUpdate(float deltaTime) {
        ...
        this.transformFlashlight.setRotation(this.transform.getRotation());

        if (this.isMovingLeft) {
            Vector3.add(this.moveDirection, this.transform.getRight(), this.moveDirection);
        }
        if (this.isMovingRight) {
            Vector3.subtract(this.moveDirection, this.transform.getRight(), this.moveDirection);
        }
        if (this.isMovingForward) {
            Vector3.add(this.moveDirection, this.transform.getForward(), this.moveDirection);
        }
        if (this.isMovingBackward) {
            Vector3.subtract(this.moveDirection, this.transform.getForward(), this.moveDirection);
        }
...
//        Vector3.add(this.transform.getPosition(), this.transform.getForward(), this.tempVector);
        this.transformFlashlight.setPosition(this.transform.getPosition());
    }

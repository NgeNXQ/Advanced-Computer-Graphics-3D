...
public final class Shader {
    ...
    public Shader(Class<?> renderPass, String sourceVert, String sourceFrag) {
        ...
        GLES32.glBindAttribLocation(this.programId, Mesh.PAYLOAD_COLOR_INDEX, "inVertexColorRGBA");
        GLES32.glBindAttribLocation(this.programId, Mesh.PAYLOAD_NORMAL_INDEX, "inVertexNormalLocal");
        GLES32.glBindAttribLocation(this.programId, Mesh.PAYLOAD_POSITION_INDEX, "inVertexPositionLocal");
